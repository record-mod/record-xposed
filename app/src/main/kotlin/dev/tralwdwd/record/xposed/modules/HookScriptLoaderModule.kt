...
import dev.tralwdwd.record.xposed.HookStateHolder
 ...
 * If the bundle file does not exist, it will attempt to load `assets://record.js` from the module's assets.
 */
        ...
        try {
            ...
            if (mainScript.exists()) runScriptFile(mainScript)
                ...
                XposedBridge.invokeOriginalMethod(
                    ...
                    thisObject,
                    arrayOf(resources.assets, "assets://record.js", loadSynchronously)
                )
            }
        } catch (e: Throwable) {
